...
class AIAgent:
    ...
    def __init__(
        ...
        if api_mode in {"chat_completions", "codex_responses", "anthropic_messages", "tinfoil", "bedrock_converse", "codex_app_server"}:
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            # Initialize per-attempt stream diagnostics so the retry block
            # can reach for them after the stream dies. Lives on
        ...
        try:
            ...
            if fb_provider == "tinfoil":
                ...
                if fb_provider == "openai-codex":
                    ...
                    # Azure OpenAI serves gpt-5.x on /chat/completions — does
                    # NOT support the Responses API. Stay on chat_completions.
                    fb_api_mode = "chat_completions"
